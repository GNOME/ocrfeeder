...
def cnv_NCName(attribute, arg, element):
    if type(arg) in (str,):
        ...
        return arg.getAttr(STYLENS, 'name')
...
def cnv_DrawNameRef(attribute, arg, element):
    try:
        return arg.getAttr(DRAWNS, 'name')
    except:
        return arg
...
attrconverters = {
	...
	((CHARTNS,'interval-minor'), None): cnv_string,
	...
	((DRAWNS,'distance'), None): cnv_string,
	((DRAWNS,'dots1'), None): cnv_integer,
	((DRAWNS,'dots1-length'), None): cnv_length,
	((DRAWNS,'dots2'), None): cnv_integer,
	((DRAWNS,'dots2-length'), None): cnv_length,
...
#	((DRAWNS,u'name'), None): cnv_string,
	...
	((FORMNS,'control-implementation'), None): cnv_string,
...
#	((FORMNS,u'value'), None): cnv_time,
	...
	((SCRIPTNS,'event-name'), None): cnv_string,
	((SCRIPTNS,'language'), None): cnv_string,
...
#	((STYLENS,u'name'), None): cnv_string,
	...
	((STYLENS,'position'), None): cnv_position,
	...
	((STYLENS,'wrap-dynamic-treshold'), None): cnv_string,
	...
	((TABLENS,'algorithm'), None): cnv_string,
	...
	((TABLENS,'condition'), None): cnv_string,
	...
	((TABLENS,'date-value-type'), None): cnv_date,
	...
	((TABLENS,'expression'), None): cnv_string,
	...
	((TABLENS,'formula'), None): cnv_string,
	...
	((TEXTNS,'condition'), None): cnv_string,
	...
	((TEXTNS,'formula'), None): cnv_string,
